...
//
//// 获取pod的owner
//func (s *Service) getPodOwnerRef(ctx context.Context, pod *corev1.Pod) (metav1.OwnerReference, error) {
//	obj, err := s.getPodOwner(ctx, pod)
//	if err != nil {
...
//
//// 获取pod的owner
//func GetPodOwner(ctx context.Context, pod *corev1.Pod, refObj *unstructured.Unstructured) (*unstructured.Unstructured, error) {
//	owner, krt, err := GetResourceOwner(pod, KRTPod, refObj)
//	if err != nil {
//		return nil, err
//	}
//	return GetUnstructured(ctx, krt.GVR(), owner.GetNamespace(), owner.GetName())
//}
//
//// 获取资源的owner
//func GetResourceOwner(obj metav1.Object, krt K8sResourceType, refObj *unstructured.Unstructured) (metav1.Object, K8sResourceType, error) {
//	refs := obj.GetOwnerReferences()
//	if len(refs) == 0 {
//		return obj, krt, nil
//	}
//
//	refKrt := ParseResourceType(refs[0].APIVersion, refs[0].Kind)
//	if refKrt == KRTUnknown {
//		return nil, KRTUnknown, errors.New(refs[0].Kind)
//	}
//
//	return GetResourceOwner(refObj, refKrt)
//}
...
//		return KRTUnknown
//	}
//	return ParseResourceType(obj["apiVersion"].(string), kind)
//}
//func ParseResourceType(apiVersion, kind string) K8sResourceType {
//	switch kind {
//	case "Deployment":
